...
export default function Navbar() {
  ...
  return (
    <nav className="navbar">
      ...
      {/* Navigation Links */}
      <ul
        className={`nav-links desktop-menu ${isMobileMenuOpen ? "open" : ""}`}
      >
        <li
          onClick={() => router.push("/")}
        ...
        >
          ...
          {hoveredLink === "collectes" && (
            <ul className="dropdown-menu">
              ...
              <li>
                <Link
                  href="/collectes/projets-en-cours"
                  onClick={(e) => e.stopPropagation()}
                >
                  Projets en cours
                </Link>
          ...
          <ul className="main-menu">
            ...
            <div className={"div-sub-menu"}>
              <li
                onClick={() =>
                  setActiveSubMenu(
                    activeSubMenu === "projects" ? null : "projects"
                  )
                }
              >
                Nos Projets
              ...
              <ul
                className={`sub-menu ${
                  activeSubMenu === "projects" ? "show" : "hide"
                }`}
              >
                <li
                  onClick={() => {
                    router.push("/projects/distribution");
                    setMobileMenuOpen(false);
                  }}
                >
                  Distribution
                ...
                <li
                  onClick={() => {
                    router.push("/projects/education");
                    setMobileMenuOpen(false);
                  }}
                >
                  Education
                ...
                <li
                  onClick={() => {
                    router.push("/projects/international");
                    setMobileMenuOpen(false);
                  }}
                >
                  International
            ...
            <div className={"div-sub-menu"}>
              <li
                onClick={() =>
                  setActiveSubMenu(
                    activeSubMenu === "collectes" ? null : "collectes"
                  )
                }
              >
                Nos Collectes
              ...
              <ul
                className={`sub-menu ${
                  activeSubMenu === "collectes" ? "show" : "hide"
                }`}
              >
                <li
                  onClick={() => {
                    router.push("/collectes/maraudes");
                    setMobileMenuOpen(false);
                  }}
                >
                  Maraudes
                ...
                <li
                  onClick={() => {
                    router.push("/collectes/projets-en-cours");
                    setMobileMenuOpen(false);
                  }}
                >
                  Projets en cours
            ...
            <div className={"div-sub-menu"}>
              <li
                onClick={() =>
                  setActiveSubMenu(
                    activeSubMenu === "contact" ? null : "contact"
                  )
                }
              >
                Contact
              ...
              <ul
                className={`sub-menu ${
                  activeSubMenu === "contact" ? "show" : "hide"
                }`}
              >
                <li
                  onClick={() => {
